...
carpeta ='SHA-LEVEL_2_Files-part1\\r26897152\\ch4\\pbcd\\'
...
import numpy as np
archivo_catalogo ="SHA-LEVEL_2_Files-part1\\r26897152\\ch4\\pbcd\\catalog_gaia.tsv"
...
#----# Se guardan las tablas como archivos .csv
  ...
  for j in filtro_final[foc]:
    ...
    counter += 1
  final_obs_table.write(f'SHA-LEVEL_2_Files-part1\\r26897152\\ch4\\pbcd\\Table_{foc}_{r}_DEFINITIVE.csv', overwrite=True)    
